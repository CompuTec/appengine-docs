...
Download the installer <!-- TODO: Link --> from here and run it.

Go to any internet browser and go to localhost:54000 (54000 is a default port set for connection; it can be changed in the Settings section <!-- TODO: Link -->).
...
For the Download SAP WebClient Extension function description, click here <!-- TODO: Link -->.
